    ...
    return WillPopScope(
      ...
      child: SafeArea(
        child: Scaffold(
          ...
          body: context.watch<MaterialProvider>().loading
              ? Center(
              ...
              : Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: context.watch<MaterialProvider>().loading
                            ? Center(
                                child: CircularProgressIndicator(),
                              )
                            : Padding(
                                padding:
                                    EdgeInsets.symmetric(horizontal: 12.0.ss),
                                child: context
                                            ...
                                            child: Dismissible(
                                                  ...
                                                  builder:
                                                    ...
                                                    return AlertDialog(
                                                      title: Text(
                                                          "Confirm Deletion"),
                                                      content: Text(
                                                          "Are you sure you want to delete ${Provider.of<MaterialProvider>(context, listen: false).materialList[index].materialName}?"),
                                                      actions: [
                                                        TextButton(
                                                          onPressed: () {
                                                            Navigator.of(
                                                          ...
                                                          onPressed: () {
                                                            Provider.of<MaterialProvider>(
                                                                    ...
                                                                    listen:
                                                                        false)
                                                                .deleteMaterial(
                                                                    materialId: Provider.of<MaterialProvider>(
                                                                            context,
                                                                            listen:
                                                                                false)
                                                                        .materialList[
                                              ...
                                              onDismissed: (direction) {
                                                ...
                                                ScaffoldMessenger.of(context)
                                                  ...
                                                  SnackBar(
                                                      content: Text(
                                                          "${Provider.of<MaterialProvider>(context, listen: false).materialList[index]} deleted")),
                                                );
                                              },
